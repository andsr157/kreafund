    ...
    <div class="col-md-12 grid-margin">
        ...
        <div class="started">
            <ul class="list-group list-group-vertical">
                        ...
                        <div class="row py-2">
                            ...
                            <div class="col-8 ms-5">
                                <div class="d-flex justify-content-center align-items-center h-100 ">
                                    <div>
                                        <p class="started-title">Tidak ada project yang selesai <a href="<?= base_url('start') ?>"></a> </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <table id="done_table" class="w-100 table-custom nowrap">
                    <thead>
                        <tr>
                            <th></th>
                        </tr>
                                        ...
                                        <div class="row py-2">
                                            ...
                                            <div class="col-9 ms-5">
                                                <div class="d-flex justify-content-between align-items-center h-100 ">
                                                    ...
                                                    <div>
                                                        <a href="<?= base_url('projects/result/' . $row->project_id) ?>">
                                                            <button type="button" id="detail-report" class="btn btn-dark py-3 btn-warning" data-project_id="<?= $row->project_id ?>" data-toggle="modal">
                                                                <i class="mdi mdi-eye "></i> Result
                                                            </button>
                                                        </a>
