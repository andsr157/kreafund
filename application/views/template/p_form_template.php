        ...
        <nav class="navbar navbar-expand-lg pt-lg-4 pb-lg-3 border border-left-0 border-right-0 border-top-0">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <button class="btn btn-dark-info text-nowrap border-0 d-none d-lg-block" style="color: #242323"
                        data-bs-toggle="modal" data-bs-target="#accountModal" data-bs-backdrop="false" type="button">
                        Log In
                    </button>
                    <button class="btn btn-dark-info text-nowrap border-0 d-block d-lg-none" style="color: #242323"
                        data-bs-toggle="modal" data-bs-target="#accountModal" type="button">
                        Log In
                    </button>
                    </form>
                </div>
