        ...
        <div class="container px-100">
            <div class="row" >
                <ul class="list-group list-group-horizontal r-nav">
                    <li class="list-group-item rcat rborder-active me-3 pb-4 rounded-0  ">
                        <p>
                            <span class="ikonr text-light"><i class="fa-solid fa-gift"></i></span>
                            <span class="type-d ms-2">Reward Items</span>
                        </p>
                    </li>
                    ...
                    <li class="list-group-item rcat pb-4 rounded-0">
                        <p>
                            ...
                            <span class="type-d ms-2 text-secondary">Items</span>
                        </p>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-4 d-flex justify-content-center align-items-center">
                    <div class="new text-center w-50">
                        <button class="btn rounded-0 w-100 btn-dark" style="color: white;">
                            <a href="<?=base_url('reward/add')?>" class="text-light">+ New Item</a>
                        </button>
                    </div>
                </div>
            </div>
