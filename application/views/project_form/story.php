...
<section class="story">
        <div class="story-title ">
            ...
            <h3 class="text-center ">Tell people why they should be excited about your project. Get specific but be
                clear and be brief.</h3>
        </div>
        ...
        <div class="container px-5">
            <div class="row pt-4 ">
                ...
                <div class="text-editor border border-2 w-100" style="height: 451px;">
        ...
        <div class="container px-5">
            <div class="row pt-4 ">
                <div class="col-5">
                    ...
                    <p class="type-d">
                        Be honest about the potential risks and challenges of this project and how you plan to overcome
                        them to complete it
                    </p>
                </div>
                <div class="col-7 side-form">
                    <textarea class="form-control rounded-0" id="exampleFormControlTextarea1" rows="3"
                        placeholder="Common risks and challenges you may want to address include budgeting, timelines for rewards and the project itself, the size of your audience..."></textarea>
                    <div class="mt-4">
                        <span class="">
                            <a href="">Communicate risks and challenges up front to set proper expectations. Learn
                                more...</a>
                        </span>
                    </div>
                </div>
        ...
        <div class="container d-flex justify-content-center">
            <div class="save">
                <button class="btn rounded-0 px-5">Save story</button>
            </div>
        </div>
