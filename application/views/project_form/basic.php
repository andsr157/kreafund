...
<div class="basic-title">
    ...
    <section class="basic">
                ...
                <div class="col-8 side-form ">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control rounded-0"
                            placeholder="Inputkan Sub Judul Singkat Projectmu">
                    </div>
                    <span class="">
            ...
            <div class="row">
                ...
                <div class="col-8 side-form ">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control rounded-0" placeholder="00,00">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-4">
                    <h4 class="mb-3">Campaign duratiom</h4>
                    <p class="type-d">
        ...
        <div class="container d-flex justify-content-center">
            <div class="save">
                <button class="btn rounded-0 px-5">Save</button>
            </div>
        </div>
    </section>  
